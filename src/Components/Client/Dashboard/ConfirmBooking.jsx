        ...
        <div className=" mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center ">
            <div className="  lg:w-[700px] lg:h-[800px] bg-primary rounded-[30px] p-6 shadow-sm border border-universal ">
              ...
              <button onClick={() => navigate(-1)} className="w-full py-3 bg-secondary text-primary rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-600 transition-colors shadow-lg shadow-blue-100" >
